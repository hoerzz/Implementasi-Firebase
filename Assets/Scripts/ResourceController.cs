...
public class ResourceController : MonoBehaviour
{
...

    {
        ...
        {
            SoundManager.smInstance.Audio.PlayOneShot(SoundManager.smInstance.failUpgrade);
            return;
        ...
        _level++;
        SoundManager.smInstance.Audio.PlayOneShot(SoundManager.smInstance.upgrade);
...

    {
        ...
        SoundManager.smInstance.Audio.PlayOneShot(SoundManager.smInstance.unclocked);
